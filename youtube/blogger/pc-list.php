...
function checkDuplicate(){
    ...
    if (file_exists($upload_path)) {
        ...
        if(!empty($files)) {
           foreach ($files as $key => $posts) {
                $vdoInfo = getFileContent($upload_path.$posts,'json');
...
function getFileContent($file,$type='json')
    {
                            ...
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                         ...
                                         foreach ($data as $key => $value):
                                            ...
                                            <td class=" "><span class="responsiveExpander"></span>
                                                <a href="<?php echo @$link;?>" target="_blank"><img src="<?php
                                                 echo $img;?>" style="float: left;max-width: 72px" class="img-rounded" />&nbsp;<?php echo @$value->title;?>
                                            </a>
                                            <?php echo @$bid;?>
                                            </td>
                                            <td class=" "><?php echo $value->label;?></td>
                                ...
                                <div class="row">
                                    <div class="dataTables_footer clearfix">
                                        <div class="col-md-6">
                                            <div class="dataTables_info" id="DataTables_Table_0_info">Showing  entries</div>
                                        </div>
                                        <div class="col-md-6">
